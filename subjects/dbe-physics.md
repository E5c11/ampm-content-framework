...
type: profile
layer: subjects
related: [AMPM-CONTENT-SCHEMA, AMPM-CONTENT-DESIGN, AMPM-CONTENT-MATHTEXT, AMPM-CONTENT-AI-EXP, AMPM-CONTENT-PIPELINE, AMPM-CONTENT-SUBJ-DBE-CHEMISTRY]
...
| Papers | `nov_p1` (physics) authored. `june_p1` presumed to exist once a June-diet paper is sourced. `nov_p2`/`june_p2` (chemistry) — see `subjects/dbe-chemistry.md`, being drafted now; lands under this same `subject_id = "physics"` per the subject/syllabus note above. |
