...
const aiExplanation = {
  sub_questions: [
    ...
    { number: '4.8.2', marks: 4, clues: '- This asks for ways OTHER than the ones already quoted from the scenario — don\'t repeat those.\n- Think about incentives, autonomy, and how failure is treated.', approach: '- Recall general ways businesses can foster a creative work environment.\n- Give ways distinct from what the scenario already described.', solution: '1. Beyond a quiet, distraction-free environment and encouraging new approaches, businesses can also reward creativity with incentive schemes, give employees autonomy and time to explore new ideas, encourage brainstorming sessions, and treat failure as part of the learning process.\n2. Any of these, or similar ways not already covered in 4.8.1, are correct.' },
