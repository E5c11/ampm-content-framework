...
const questions = [
  ...
  },
  {
    ...
    metadata: [
      'Body paragraph: the advantages insurance offers a business',
      'Conclusion: restating how insurance and assurance both support sound financial planning',
      'Body paragraph: the differences between insurance and assurance',
      'Introduction: outlining that the essay will cover insurance vs. assurance, compulsory insurance, advantages, and key principles',
      'Body paragraph: utmost good faith and insurable interest as insurance principles',
      'Body paragraph: the types of compulsory insurance a business must have',
    ],
    answer: [
      'Introduction: outlining that the essay will cover insurance vs. assurance, compulsory insurance, advantages, and key principles',
      'Body paragraph: the differences between insurance and assurance',
