...
const questions = [
  ...
  },
  {
    ...
    metadata: [
      'Body paragraph: age and disability as diversity issues, and how to address them',
      'Body paragraph: three human rights businesses must uphold in the workplace',
      'Introduction: outlining that the essay will cover employer health/safety duties, workplace human rights, environmental strategies, and diversity issues',
      'Body paragraph: strategies to protect the environment and human health',
      'Conclusion: restating how upholding these responsibilities builds a fair, sustainable workplace',
      'Body paragraph: employer responsibilities for promoting human health and safety',
    ],
    answer: [
      'Introduction: outlining that the essay will cover employer health/safety duties, workplace human rights, environmental strategies, and diversity issues',
      'Body paragraph: employer responsibilities for promoting human health and safety',
