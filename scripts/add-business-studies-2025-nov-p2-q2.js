...
const aiExplanation = {
  sub_questions: [
    ...
    { number: '2.6.2', marks: 4, clues: '- This asks for aspects OTHER than the ones already quoted from the scenario — don\'t repeat those.\n- Think about audience, delivery, and slide design more broadly.', approach: '- Recall the general factors to consider when designing a multimedia presentation.\n- Give aspects distinct from what the scenario already described.', solution: '1. Beyond simplifying graphs and limiting on-slide text, a presenter should also consider audience background/needs, appropriate font size and colour contrast, avoiding cluttered slides, and rehearsing timing.\n2. Any of these, or similar aspects not already covered in 2.6.1, are correct.' },
