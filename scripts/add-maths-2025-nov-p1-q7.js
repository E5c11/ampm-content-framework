...
const aiExplanation = {
  sub_questions: [
    ...
    },
    {
      ...
      approach: '- Quarterly rate: i = \\frac{0.058}{4}.\n- Deposits from 1 Jan 2020 to 1 Oct 2025 = 24.\n- Use F = \\frac{x[(1 + i)^n − 1]}{i}, then multiply by (1 + i) once more for the extra quarter to 1 Jan 2026.',
      solution: '1. i = \\frac{0.058}{4} = 0.0145;  n = 24 deposits\n2. F = \\frac{2300[(1.0145)^{24} − 1]}{0.0145} × (1.0145)\n3. F = R66 411.60',
    },
    {
      number: '7.3.1',
      marks: 5,
      ...
      approach: '- Grow R900 000 for 3 months: A = 900 000(1 + \\frac{0.068}{12})^3.\n- Set this equal to the present value of the R10 000 payments: P = \\frac{x[1 − (1 + i)^{−n}]}{i}.\n- Solve for n using logarithms.\n- Add the 3 deferred months and round up to completed months.',
      solution: '1. A = 900 000(1 + \\frac{0.068}{12})^3 = R915 386.86\n2. 915 386.86 = \\frac{10 000[1 − (1 + \\frac{0.068}{12})^{−n}]}{\\frac{0.068}{12}}\n3. (1 + \\frac{0.068}{12})^{−n} = 0.4812…\n4. n = 129.419… payments\n5. Total time = 129.419… + 3 = 132.419… ⟹ 133 completed months',
    },
    {
      number: '7.3.2',
      marks: 4,
