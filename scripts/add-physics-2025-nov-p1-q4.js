...
const questions = [
  ...
  },
  {
    ...
    syllabus: 'dbe', subject: 'physics', year: 2025, paper: 'nov_p1',
    clues: '- Use Fₙₑₜ·Δt = Δp = p(f) − pᵢ. Take the direction after the bounce as positive, so the initial momentum is negative.\n- Solve for pᵢ, then divide by mass to get vᵢ.',
  },
  {
    name: 'Question 4',
...
const aiExplanation = {
  sub_questions: [
    ...
    },
    {
      ...
      solution: '1. Line A: unchanged, as originally drawn.\n2. Line B: parallel to line A (same gradient, since Fₙₑₜ is unchanged) but shifted, reflecting a more negative initial momentum for the bigger mass at the same initial velocity.',
    },
  ],
